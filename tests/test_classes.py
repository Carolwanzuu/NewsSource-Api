...
class SourceTest(unittest.TestCase):
    ...
    '''
    def setUp(self):
        self.new_source = Source('reuters','U.S. Republicans vow to oppose Yellen's G7 tax deal, casting doubt on its future - Reuters', 'Desperation should drive funding for Alzheimer's research, it should not drive the interpretation of scientific evidence,\" Karlawish said. ','https://www.reuters.com/world/us/us-republicans-vow-oppose-yellens-g7-tax-deal-casting-doubt-its-future-2021-06-08/' 'business', 'http://www.argaam.com','business', 'US' )
